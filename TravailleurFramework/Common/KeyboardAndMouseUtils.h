...
private:
    ...
    static void assureKeyToNativeMapIsInitialized();
    ...
    static int getNativeFromKey(const KeyboardAndMouseDefs::Key key);

    static std::set<KeyboardAndMouseDefs::Key> keys;
    static std::map<KeyboardAndMouseDefs::Key, int> keyToNative;
};
